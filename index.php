                        ...
                        <div class="card h-100 course-card">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="rating mb-2">
                                    ...
                                    <i class="fas fa-star text-warning"></i>
                                    <i class="fas fa-star-half-alt text-warning"></i>
                                    <span class="text-muted">(76,543)</span>
                                </div>
                                <h5 class="mt-auto fw-bold">₹499 <small class="text-muted text-decoration-line-through">₹3,199</small></h5>
                            </div>
                        </div>
                        ...
                        <div class="card h-100 course-card">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="rating mb-2">
                                    ...
                                    <i class="fas fa-star text-warning"></i>
                                    <i class="fas fa-star text-warning"></i>
                                    <span class="text-muted">(21,345)</span>
                                </div>
                                <h5 class="mt-auto fw-bold">₹499 <small class="text-muted text-decoration-line-through">₹3,199</small></h5>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6">
                        <div class="category-box p-4 text-center fw-bold">Design</div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="category-box p-4 text-center fw-bold">Development</div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="category-box p-4 text-center fw-bold">Marketing</div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="category-box p-4 text-center fw-bold">IT & Software</div>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="card-body">
                                <blockquote class="blockquote mb-0">
                                    ...
                                    <footer class="blockquote-footer d-flex align-items-center">
                                        ...
                                        Priya Sharma <cite title="Source Title">, Web Developer</cite>
                                    </footer>
                                </blockquote>
                            </div>
                        </div>
